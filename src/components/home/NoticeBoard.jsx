...
const NoticeBoard = () => {
  ...
  return (
    <div className="flex items-center justify-center bg-gray-100 py-20 relative overflow-hidden">
      {isLoading ? (
        <Spinner />
      ) : (
          ...
          >
            <SwiperSlide>
              <div className="px-4">
                ...
                <a
                  href="#"
                  className="bg-white pb_text_red rounded-full px-5 py-2 font-medium mt-3 flex w-fit items-center text-xs sm:text-sm md:text-base lg:text-lg"
                >
            ...
            <SwiperSlide>
              <ul className="list-disc pl-5 space-y-4 text-sm sm:text-base md:text-lg mb-5">
