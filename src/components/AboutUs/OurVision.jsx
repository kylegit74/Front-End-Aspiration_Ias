...
function OurVision() {
  const visionPoints = [
    ...
    },
    {
      ...
      description: 'Setting the highest standards in civil services coaching and preparation',
    },
    {
      icon: Trophy,
      ...
      <div className="relative z-20 mx-auto max-w-7xl">
        ...
        <div className="text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-gray-600">
            Empowering aspirants with knowledge, strategy, and confidence to excel in civil services examinations
          </p>
        </div>
